...
class ScaleCylinderShapeCollectionViewCell: BaseShapeCollectionViewCell, ScaleTransformView {
    ...
    var scaleOptions: ScaleTransformViewOptions {
        .init(
            ...
            shadowEnabled: false,
            rotation3d: .init(angle: .pi / 4, minAngle: -.pi, maxAngle: .pi, x: 0, y: 1, z: 0, m34: -0.000_4 - (320 / frame.width) * 0.000_2 ),
            translation3d: .init(translateRatios: (0, 0, 0), minTranslates: (0, 0, frame.width * 0.8), maxTranslates: (0, 0, frame.width * 0.8))
        )
    }
}
    ...
    var scaleOptions: ScaleTransformViewOptions {
        .init(
            ...
            translation3d: .init(translateRatios: (0, 0, 0),
                                 minTranslates: (0, 0, frame.width * 0.57),
                                 maxTranslates: (0, 0, -frame.width * 0.57))
        )
    }
}
...
class ScaleCoverFlowShapeCollectionViewCell: BaseShapeCollectionViewCell, ScaleTransformView {
    ...
    var scaleOptions: ScaleTransformViewOptions {
        ScaleTransformViewOptions(
            ...
            translation3d: .init(translateRatios: (30, 0, -frame.width * 0.42), minTranslates: (-30, 0, -1_000), maxTranslates: (30, 0, 0))
        )
    }
}
...
class ScaleRotaryShapeCollectionViewCell: BaseShapeCollectionViewCell, ScaleTransformView {
    ...
    var scaleOptions: ScaleTransformViewOptions {
        ScaleTransformViewOptions(
            ...
            translation3d: .init(translateRatios: (200, frame.width * 0.1, 0),
                                 minTranslates: (-1_000, -frame.width, -100),
                                 maxTranslates: (1_000, frame.width, -100))
        )
    }
}
